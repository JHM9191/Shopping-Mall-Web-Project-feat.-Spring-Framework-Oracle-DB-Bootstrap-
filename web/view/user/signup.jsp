...
<body class="bg-white">
    ...
    <section class="login_part section_padding">
         <form action="signupimpl.sp">
              <div class="mt-10">
                     <input type="text" name="u_id" placeholder="ID" onfocus="this.placeholder = ''"
                        onblur="this.placeholder = 'ID'" required class="single-input">
                  </div>
                  
                  <div class="mt-10">
                     <input type="text" name="u_pwd" placeholder="PASSWARD" onfocus="this.placeholder = ''"
                        onblur="this.placeholder = 'PASSWARD'" required class="single-input">
                  </div>
                  ...
                  <div class="mt-10">
                     <input type="text" name="u_tel" placeholder="Phone Number"
                        onfocus="this.placeholder = ''" onblur="this.placeholder = 'Phone Number'" required class="single-input">
                  </div>
                  ...
                  <div class="mt-10">
                     <input type="text" name="u_age" placeholder="Age"
                        onfocus="this.placeholder = ''" onblur="this.placeholder = 'Age'" required class="single-input">
                  </div>
                  <div class="mt-10">
                     <input type="text" name="u_email" placeholder="Email address" onfocus="this.placeholder = ''"
                    ...
                    <div class="single_footer_part">
                        ...
                        <div id="mc_embed_signup">
                            <form target="_blank"
                                ...
                                <input type="text" name="u_email" id="newsletter-form-email" placeholder="Email Address"
